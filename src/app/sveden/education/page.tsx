...
import { EducationTables } from "@/shared/ui/vsau/sveden";
    ...
    return (
        <>
            <TemplatePage title="Образование">
                ...
                <DocumentListBlock title="Информация о результатах перевода, восстановления и отчисления" itemProp="eduPerevodEl" docList={docs[5]} />
            </TemplatePage>
        </>
    );
};
