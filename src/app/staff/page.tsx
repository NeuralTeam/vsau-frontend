...
const Staff = () => {
	return (
		<div className='bg-slate-100 min-h-screen w-full p-10'>
			<div className='flex items-end justify-start'>
				<StaffIcon width={50} fill='#0F91D6' />
				<p className='ml-4 text-[#0F91D6] font-semibold text-2xl'>Персонал</p>
			</div>
			<div className='grid grid-cols-2 my-20'>
				<div className='bg-[#0F91D6] flex items-center justify-center w-11/12 hover:border-[#0F91D6] border-2 rounded-lg cursor-pointer  transition-all'>
				...
				<div className='bg-[#ffffff] p-20 w-10/12 rounded-lg cursor-pointer transition-all hover:border-[#ffffff] border-2 border-slate-100'>
