...
export interface ICateringInfo {
    food_conditions: ICateringInfoData[];
    health_protection_conditions: ICateringInfoData[];
}

export const CollapsingCateringTable = ({ cateringInfo }: { cateringInfo: ICateringInfo }) => {
