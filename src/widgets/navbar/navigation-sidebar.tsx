...
const NavigationSidebar = () => {
    ...
    return (
        <nav className="flex h-full w-[30%] flex-col items-center justify-between bg-[#0F91D6]">
                ...
                <Link href="/" className="mt-8 flex items-center justify-center overflow-hidden px-6 2xl:px-8">
                    <div>
                        <VsauLogoIcon
                            ...
                            height={100}
                            fill="#FFFFFF"
                            className="max-h-[80px] max-w-[80px] 2xl:max-h-[100px] 2xl:max-w-[100px]"
                        />
                    </div>

                    <div className="items-center space-y-1 text-white">
                        <p className="ml-5 line-clamp-2 text-[8px] font-normal leading-3 2xl:text-[10px]">
                            Федеральное государственное бюджетное образовательное учреждение высшего образования
                        </p>
                        <p className="ml-5 line-clamp-3 text-[14px] font-semibold leading-[17px] 2xl:text-[16px]">
            ...
            <div
                className={cn(
                    "hidden h-[80px] w-full items-center justify-between bg-white px-16 2xl:flex",
